			...
			<xsl:when test="$login = ''">
				<div class="tabs-content module {$module}-module">
					<div class="section selected">
						...
						<form class="form_modify"  method="post" action="/admin/emarket/saveApiShipUser/{$oid}/" enctype="multipart/form-data">
		...
		<xsl:choose>
			<xsl:when test="$login = ''">
				<div class="panel-settings">
					<a data-name="orders" data-label="&label-register-in-api-ship;"></a>
					<div class="title">
