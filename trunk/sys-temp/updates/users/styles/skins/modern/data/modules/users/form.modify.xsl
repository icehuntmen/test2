...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:umi="http://www.umi-cms.ru/TR/umi">
	...
	<xsl:template match="object" mode="form-modify" priority="1">
		...
		<xsl:apply-templates select="document(concat('udata://users/choose_perms/', $param0))/udata" />
	</xsl:template>
			...
			<div class="column">
				<div class="row">
					<xsl:apply-templates select="field[@name = 'login']" mode="form-modify">
						<xsl:with-param name="class">col-md-8</xsl:with-param>
					</xsl:apply-templates>
	...
	<xsl:template match="/result[@module = 'users' and @method = 'edit']//field[@type = 'password']" mode="form-modify">
		...
		<div class="col-md-8 password-repeat">
			<div class="title-edit">
				<acronym>
	...
	<xsl:template match="/result[@module = 'users' and @method = 'add']//field[@type = 'password']" mode="form-modify">
		<div class="col-md-8 default-empty-validation">
			<div class="title-edit">
				<acronym title="{@tip}">
					<xsl:value-of select="@title" />
				</acronym>
		...
		<div class="col-md-8 default-empty-validation password-repeat">
			<div class="title-edit">
				<acronym>
					<xsl:text>&label-repeat-password;</xsl:text>
				</acronym>
	...
	<xsl:template match="udata[@module = 'users' and @method = 'choose_perms']">
		<div class="panel-settings" name="g_perms">
