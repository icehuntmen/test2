...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="result[@method = 'filters']">
		...
		<script type="text/javascript" src="/styles/skins/modern/data/modules/catalog/filters/admin.indexing.js?{$system-build}"></script>
		<script type="text/javascript" src="/styles/skins/modern/data/modules/catalog/filters/loadingoverlay/js/loadingoverlay.min.js?{$system-build}"></script>
	</xsl:template>
