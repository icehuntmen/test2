<?php
	...
	class uselStream extends umiBaseStream {
		...
		protected $modes = ['objects' => 'objects', 'pages' => 'pages', 'count' => 'count', 'objects count' => 'objects', 'pages count' => 'pages'];
		...
		protected function parsePath($path) {
			...
			$path = preg_replace_callback("/\(([^\)]+)\)/U",function ($m){
		...
		protected function getTargets(DOMElement $selectionNode) {
            ...
            if (mb_strpos($targetResult, ' ') !== false) {
