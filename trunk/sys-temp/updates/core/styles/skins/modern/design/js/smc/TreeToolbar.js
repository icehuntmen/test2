		...
		__appendButton(btns, {
			...
			init: function(button) {
				if (HandleItem !== null && HandleItem.allowActivity) {
					var className = HandleItem.isActive ? 'small-ico i-vision' : 'small-ico i-hidden';
			...
			release: function(button) {
				if (HandleItem !== null) {
					...
					if (__isOnlyOneItemSelected()) {
						className = HandleItem.isActive ? 'small-ico i-vision' : 'small-ico i-hidden';
						hint = HandleItem.isActive ? getLabel('js-enable-page') : getLabel('js-disable-page');
						button.element.setAttribute('title', hint);
						button.element.firstChild.className = className;
						...
						className = checked ? 'small-ico i-vision' : 'small-ico i-hidden';
						hint = checked ? getLabel('js-enable-page') : getLabel('js-disable-page');
						button.element.setAttribute('title', hint);
						button.element.firstChild.className = className;
