	...
	class FaqAdmin {
		...
		public function add() {
			...
			if ($mode == 'do') {
				...
				$this->chooseRedirect("{$this->module->pre_lang}/admin/faq/edit/{$element_id}/");
			}
		...
		public function config() {
			...
			if ($mode == 'do') {
				...
				$umiRegistry->set('//modules/faq/disable_new_question_notification', $params['config']['boolean:disable_new_question_notification']);
			...
			$params['config']['boolean:disable_new_question_notification'] = (int) $umiRegistry->get('//modules/faq/disable_new_question_notification');

			if ($umiNotificationInstalled) {
				$params['config']['boolean:use-umiNotifications'] = (bool) $umiRegistry->get('//modules/faq/use-umiNotifications');
			}
