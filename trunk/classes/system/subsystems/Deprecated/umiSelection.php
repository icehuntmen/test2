<?php
	...
	class umiSelection implements iUmiSelection {
		...
		public function addPropertyFilterBetween($field_id, $min, $max) {
			...
			$filter = ["type" => $data_type, "field_id" => $field_id, "filter_type" => "between", "min" => $min, "max" => $max];
			$this->props[] = $filter;
		}
		...
		public function addPropertyFilterEqual($field_id, $value, $case_insencetive = true) {
			...
			$filter = ["type" => $data_type, "field_id" => $field_id, "filter_type" => "equal", "value" => $value, "case_insencetive" => $case_insencetive];
			$this->props[] = $filter;
		}
		...
		public function addPropertyFilterNotEqual($field_id, $value, $case_insencetive = true) {
			...
			$filter = ["type" => $data_type, "field_id" => $field_id, "filter_type" => "not_equal", "value" => $value, "case_insencetive" => $case_insencetive];
			$this->props[] = $filter;
		}
		...
		public function addPropertyFilterLike($field_id, $value, $case_insencetive = true) {
			...
			$filter = ["type" => $data_type, "field_id" => $field_id, "filter_type" => "like", "value" => $value, "case_insencetive" => $case_insencetive];
			$this->props[] = $filter;
		}
