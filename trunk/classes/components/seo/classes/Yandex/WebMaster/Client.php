<?php
	...
	class Client extends JsonClient implements iClient {
		...
		public function deleteSite($siteId) {
			...
			return empty($this->getResponse($request));
		}
		...
		public function getIndexingHistory(
			$siteId, $indicator = self::INDEXING_INDICATOR_SEARCHABLE, $from = null, $to = null
		) {
		...
		public function getPopularQueryList(
			$siteId, $order = self::QUERY_ORDER_FIELD_TOTAL_SHOWS, $indicator = self::QUERY_INDICATOR_TOTAL_SHOWS
		) {
