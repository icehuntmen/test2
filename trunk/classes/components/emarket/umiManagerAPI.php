<?php
	...
	class EmarketUMIManagerAPI {
		...
		public function addToken() {
			...
			if (mb_strlen($token) == 0 || mb_strlen($platform) == 0 || !in_array($platform, ['android', 'ios'])) {
				$this->admin->setData([
					'@result' => 'error'
				]);
			...
			$request = [
				...
				'keycode' => $umiRegistry->get('//settings/keycode'),
				'build' => $umiRegistry->get('//modules/autoupdate/system_build'),
