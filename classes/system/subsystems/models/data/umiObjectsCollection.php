...
SQL;
		...
		public function cloneObject($id) {
			...
			if ($oObject instanceof iUmiObject) {
				...
				$sSql = "INSERT INTO cms3_objects (name, guid, is_locked, type_id, owner_id, ord, updatetime) SELECT name, guid, is_locked, type_id, owner_id, ord, updatetime FROM cms3_objects WHERE id = '{$id}'";
				...
				$sSql = "INSERT INTO cms3_object_content (obj_id, field_id, int_val, varchar_val, text_val, rel_val, tree_val,float_val)  SELECT '{$iNewObjectId}' as obj_id, field_id, int_val, varchar_val, text_val, rel_val, tree_val,float_val FROM cms3_object_content WHERE obj_id = '$id'";
				$connection->query($sSql);
