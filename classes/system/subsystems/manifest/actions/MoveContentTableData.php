<?php
	/** Команда переноса значений полей объектов заданного иерархического типа из общей таблицы в отдельную */
...
SQL;
		...
		/** Переносит значения полей объектов заданного иерархического типа из общей таблицы в отдельную */
