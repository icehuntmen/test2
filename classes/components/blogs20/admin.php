<?php
	...
	class Blogs20Admin {
		...
		public function config() {
			...
			$params['user']['boolean:allow_guest_comments'] = (bool) $regedit->get('//modules/blogs20/allow_guest_comments');
			$params['user']['boolean:moderate_comments'] = (bool) $regedit->get('//modules/blogs20/moderate_comments');
			$params['notifications']['boolean:on_comment_add'] = (bool) $regedit->get('//modules/blogs20/notifications/on_comment_add');

			if ($umiNotificationInstalled) {
				$params['notifications']['boolean:use-umiNotifications'] = (bool) $regedit->get('//modules/blogs20/use-umiNotifications');
			}
