<?php
	...
	class AppointmentNotifier {
		...
		public function sendNewAppointmentNotifyToManager(AppointmentOrder $order) {
			...
			$emailTo = $umiRegistry->get('//settings/admin_email');
			$noReply = $umiRegistry->get('//settings/email_from');
		...
		protected function getEmployeeName(AppointmentOrder $order) {
			...
			return ($employee instanceof AppointmentEmployee) ? $employee->getName() : getLabel('notify-default-employee', 'appointment');
		}
