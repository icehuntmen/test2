<?php
	...
	$i18n = [
		...
		'js-label-not-last-version-warning-text' => 'У вас используется не последняя версия системы UMI.CMS. Устанавливаемые модули могут работать некорректно. Рекомендуем обновить версию UMI.CMS или сделать резервную копию.',
