<?php
	...
	class ForumMacros {
		 ...
		 * @throws selectorException
		 */
		public function conf($template = 'default', $per_page = false, $ignore_context = false, $ignore_paging = false, $confId = false) {
			if (!$template) {
				$template = 'default';
			}
		...
		public function message_post_do() {
			...
			if (!mb_strlen(trim($title)) && ($parent_element instanceof iUmiHierarchyElement)) {
