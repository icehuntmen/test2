<?php
	class umiEventFeed {
		...
		*/
		public static function getList(array $types = [], $userId, $limit = null, $offset = null, $startDate = null, $endDate = null) {
		...
		*/
		...
		public function load() {
			$id = (int) $this->id;
			$eventInfo = self::getConnection()->queryResult("SELECT type_id, date, params FROM umi_event_feeds WHERE id = {$id}");
