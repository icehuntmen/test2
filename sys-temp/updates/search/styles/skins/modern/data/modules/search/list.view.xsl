										...
										<tr>
											...
											<td width="250">
												...
												<div title="&snr-catalog;">
													<div class="checkbox">
														<input type="checkbox" class="row_selector" name="contentType[catalog]" id="contentTypeNews">
															<xsl:if test="contentTypes/contentType = 'catalog'">
																<xsl:attribute name="checked" />
															</xsl:if>
														</input>
													</div>
													<label for="contentTypeNews" class="name_col">&snr-catalog;</label>
												</div>
												<div title="&snr-comments;">
													<div class="checkbox">
														<input type="checkbox" class="row_selector" name="contentType[comments]" id="contentTypeNews">
															<xsl:if test="contentTypes/contentType = 'comments'">
																<xsl:attribute name="checked" />
															</xsl:if>
														</input>
													</div>
													<label for="contentTypeNews" class="name_col">&snr-comments;</label>
												</div>
												<div title="&snr-faq;">
													<div class="checkbox">
														<input type="checkbox" class="row_selector" name="contentType[faq]" id="contentTypeNews">
															<xsl:if test="contentTypes/contentType = 'faq'">
																<xsl:attribute name="checked" />
															</xsl:if>
														</input>
													</div>
													<label for="contentTypeNews" class="name_col">&snr-faq;</label>
												</div>
												<div title="&snr-forum;">
													<div class="checkbox">
														<input type="checkbox" class="row_selector" name="contentType[forum]" id="contentTypeNews">
															<xsl:if test="contentTypes/contentType = 'forum'">
																<xsl:attribute name="checked" />
															</xsl:if>
														</input>
													</div>
													<label for="contentTypeNews" class="name_col">&snr-forum;</label>
												</div>
												<div title="&snr-photoalbum;">
													<div class="checkbox">
														<input type="checkbox" class="row_selector" name="contentType[photoalbum]" id="contentTypeNews">
															<xsl:if test="contentTypes/contentType = 'photoalbum'">
																<xsl:attribute name="checked" />
															</xsl:if>
														</input>
													</div>
													<label for="contentTypeNews" class="name_col">&snr-photoalbum;</label>
												</div>
												<div title="&snr-all;">
													<div class="checkbox">
														<input type="checkbox" class="row_selector" name="contentType[all]" id="contentTypeNews">
															<xsl:if test="contentTypes/contentType = 'all'">
																<xsl:attribute name="checked" />
															</xsl:if>
														</input>
													</div>
													<label for="contentTypeNews" class="name_col">&snr-all;</label>
												</div>
											</td>
										</tr>
